      ...
      [
        {
          ...
          text: "Let's set up this project. Please run through the following steps:\n\n" +
            ...
            "3. **Git** — Check if git is initialised. If not, ask if I'd like to init and create a .gitignore that includes `.pi/` (local pi config) and standard ignores for the project type. `.ai/history/` should not be gitignored - session logs are part of the project record.\n\n" +
