...
export default function (pi: ExtensionAPI) {
  pi.on("session_shutdown", (_evt, ctx) => {
    ...
    try {
      ...
      if (!sessionDir || !sessionDir.includes("history")) return;
